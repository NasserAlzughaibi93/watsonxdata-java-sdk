...
<head>
    ...
    <title>IBM Cloud Watsonx-data</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" crossorigin="anonymous">
</head>
<body>
<div class="container">
    <div class="page-header">
        <h1>IBM Cloud Watsonx-data Java SDK Documentation</h1>
    </div>

    <p><a href="https://cloud.ibm.com/apidocs?category=watsonx-data">Watsonx-data Info</a>
        | <a href="https://github.com/IBM/watsonxdata-java-sdk">GitHub</a>
    </p>
