...
/**
 * Unit test class for the GetPrestoEngineOKBody model.
 */
public class GetPrestoEngineOKBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetPrestoEngineOKBody() throws Throwable {
    GetPrestoEngineOKBody getPrestoEngineOkBodyModel = new GetPrestoEngineOKBody();
    assertNull(getPrestoEngineOkBodyModel.getEngine());
    assertNull(getPrestoEngineOkBodyModel.getResponse());
  }
}