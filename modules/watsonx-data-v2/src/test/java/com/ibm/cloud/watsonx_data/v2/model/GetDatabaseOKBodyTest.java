...
/**
 * Unit test class for the GetDatabaseOKBody model.
 */
public class GetDatabaseOKBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetDatabaseOKBody() throws Throwable {
    GetDatabaseOKBody getDatabaseOkBodyModel = new GetDatabaseOKBody();
    assertNull(getDatabaseOkBodyModel.getDatabase());
    assertNull(getDatabaseOkBodyModel.getResponse());
  }
}