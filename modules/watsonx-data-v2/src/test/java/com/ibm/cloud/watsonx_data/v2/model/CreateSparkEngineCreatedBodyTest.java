...
/**
 * Unit test class for the CreateSparkEngineCreatedBody model.
 */
public class CreateSparkEngineCreatedBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateSparkEngineCreatedBody() throws Throwable {
    CreateSparkEngineCreatedBody createSparkEngineCreatedBodyModel = new CreateSparkEngineCreatedBody();
    assertNull(createSparkEngineCreatedBodyModel.getEngine());
    assertNull(createSparkEngineCreatedBodyModel.getResponse());
  }
}