...
/**
 * Unit test class for the GetDeploymentsOKBody model.
 */
public class GetDeploymentsOKBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetDeploymentsOKBody() throws Throwable {
    GetDeploymentsOKBody getDeploymentsOkBodyModel = new GetDeploymentsOKBody();
    assertNull(getDeploymentsOkBodyModel.getDeploymentresponse());
    assertNull(getDeploymentsOkBodyModel.getResponse());
  }
}