...
/**
 * Unit test class for the ListSparkEnginesOKBody model.
 */
public class ListSparkEnginesOKBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListSparkEnginesOKBody() throws Throwable {
    ListSparkEnginesOKBody listSparkEnginesOkBodyModel = new ListSparkEnginesOKBody();
    assertNull(listSparkEnginesOkBodyModel.getResponse());
    assertNull(listSparkEnginesOkBodyModel.getSparkEngines());
  }
}