...
/**
 * Unit test class for the CreateEngineCreatedBody model.
 */
public class CreateEngineCreatedBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateEngineCreatedBody() throws Throwable {
    CreateEngineCreatedBody createEngineCreatedBodyModel = new CreateEngineCreatedBody();
    assertNull(createEngineCreatedBodyModel.getEngine());
    assertNull(createEngineCreatedBodyModel.getResponse());
  }
}