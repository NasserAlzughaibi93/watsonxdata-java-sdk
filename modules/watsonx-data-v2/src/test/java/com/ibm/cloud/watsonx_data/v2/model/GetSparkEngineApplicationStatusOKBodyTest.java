...
/**
 * Unit test class for the GetSparkEngineApplicationStatusOKBody model.
 */
public class GetSparkEngineApplicationStatusOKBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetSparkEngineApplicationStatusOKBody() throws Throwable {
    GetSparkEngineApplicationStatusOKBody getSparkEngineApplicationStatusOkBodyModel = new GetSparkEngineApplicationStatusOKBody();
    assertNull(getSparkEngineApplicationStatusOkBodyModel.getApplication());
    assertNull(getSparkEngineApplicationStatusOkBodyModel.getResponse());
  }
}