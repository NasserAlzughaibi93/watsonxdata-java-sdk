...
/**
 * Unit test class for the UpdateDatabaseOKBody model.
 */
public class UpdateDatabaseOKBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateDatabaseOKBody() throws Throwable {
    UpdateDatabaseOKBody updateDatabaseOkBodyModel = new UpdateDatabaseOKBody();
    assertNull(updateDatabaseOkBodyModel.getDatabase());
    assertNull(updateDatabaseOkBodyModel.getResponse());
  }
}