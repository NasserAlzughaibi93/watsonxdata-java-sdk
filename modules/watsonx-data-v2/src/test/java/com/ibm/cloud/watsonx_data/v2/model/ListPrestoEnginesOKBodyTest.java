...
/**
 * Unit test class for the ListPrestoEnginesOKBody model.
 */
public class ListPrestoEnginesOKBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListPrestoEnginesOKBody() throws Throwable {
    ListPrestoEnginesOKBody listPrestoEnginesOkBodyModel = new ListPrestoEnginesOKBody();
    assertNull(listPrestoEnginesOkBodyModel.getPrestoEngines());
    assertNull(listPrestoEnginesOkBodyModel.getResponse());
  }
}