...
public class PrestissimoNodeDescriptionBodyTest {
  ...
  public void testPrestissimoNodeDescriptionBody() throws Throwable {
    PrestissimoNodeDescriptionBody prestissimoNodeDescriptionBodyModel = new PrestissimoNodeDescriptionBody();
    assertNull(prestissimoNodeDescriptionBodyModel.getNodeType());
    assertNull(prestissimoNodeDescriptionBodyModel.getQuantity());
  }
}