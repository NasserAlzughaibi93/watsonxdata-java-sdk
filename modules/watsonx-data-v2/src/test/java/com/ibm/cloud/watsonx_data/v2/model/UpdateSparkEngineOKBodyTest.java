...
/**
 * Unit test class for the UpdateSparkEngineOKBody model.
 */
public class UpdateSparkEngineOKBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateSparkEngineOKBody() throws Throwable {
    UpdateSparkEngineOKBody updateSparkEngineOkBodyModel = new UpdateSparkEngineOKBody();
    assertNull(updateSparkEngineOkBodyModel.getEngine());
    assertNull(updateSparkEngineOkBodyModel.getResponse());
  }
}