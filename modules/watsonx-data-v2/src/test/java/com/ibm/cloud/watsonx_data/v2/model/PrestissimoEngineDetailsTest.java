...
public class PrestissimoEngineDetailsTest {
  ...
  public void testPrestissimoEngineDetails() throws Throwable {
    PrestissimoEngineDetails prestissimoEngineDetailsModel = new PrestissimoEngineDetails();
    assertNull(prestissimoEngineDetailsModel.getConnectionString());
    assertNull(prestissimoEngineDetailsModel.getEndpoints());
    assertNull(prestissimoEngineDetailsModel.getMetastoreHost());
  }
}