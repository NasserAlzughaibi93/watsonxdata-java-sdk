...
/**
 * Unit test class for the ListEnginesOKBody model.
 */
public class ListEnginesOKBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListEnginesOKBody() throws Throwable {
    ListEnginesOKBody listEnginesOkBodyModel = new ListEnginesOKBody();
    assertNull(listEnginesOkBodyModel.getEngines());
    assertNull(listEnginesOkBodyModel.getResponse());
  }
}