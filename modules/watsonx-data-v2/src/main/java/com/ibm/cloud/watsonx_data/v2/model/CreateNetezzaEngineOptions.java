...
public class CreateNetezzaEngineOptions extends GenericModel {
  ...
  protected CreateNetezzaEngineDetails engineDetails;
  ...
  public static class Builder {
    ...
    private CreateNetezzaEngineDetails engineDetails;
    ...
    private Builder(CreateNetezzaEngineOptions createNetezzaEngineOptions) {
      ...
      this.type = createNetezzaEngineOptions.type;
     ...
     * @return the CreateNetezzaEngineOptions builder
     */
    public Builder engineDetails(CreateNetezzaEngineDetails engineDetails) {
   ...
   */
  public CreateNetezzaEngineDetails engineDetails() {
