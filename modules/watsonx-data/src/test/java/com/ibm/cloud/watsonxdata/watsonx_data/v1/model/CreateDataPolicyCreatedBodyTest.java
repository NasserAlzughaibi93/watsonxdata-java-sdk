...
/**
 * Unit test class for the CreateDataPolicyCreatedBody model.
 */
public class CreateDataPolicyCreatedBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateDataPolicyCreatedBody() throws Throwable {
    CreateDataPolicyCreatedBody createDataPolicyCreatedBodyModel = new CreateDataPolicyCreatedBody();
    assertNull(createDataPolicyCreatedBodyModel.getDataPolicy());
    assertNull(createDataPolicyCreatedBodyModel.getMetadata());
    assertNull(createDataPolicyCreatedBodyModel.getResponse());
  }
}