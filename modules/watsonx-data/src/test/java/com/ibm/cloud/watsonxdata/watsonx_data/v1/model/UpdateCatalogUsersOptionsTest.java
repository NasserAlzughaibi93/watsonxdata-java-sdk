...
/**
 * Unit test class for the UpdateCatalogUsersOptions model.
 */
public class UpdateCatalogUsersOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateCatalogUsersOptions() throws Throwable {
    ...
    UpdateCatalogUsersOptions updateCatalogUsersOptionsModel = new UpdateCatalogUsersOptions.Builder()
      ...
      .build();
    assertEquals(updateCatalogUsersOptionsModel.catalogName(), "testString");
    assertEquals(updateCatalogUsersOptionsModel.groups(), java.util.Arrays.asList(catalogGroupsMetadataModel));
    assertEquals(updateCatalogUsersOptionsModel.users(), java.util.Arrays.asList(catalogUsersMetadataModel));
    assertEquals(updateCatalogUsersOptionsModel.lhInstanceId(), "testString");
    assertEquals(updateCatalogUsersOptionsModel.authInstanceId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateCatalogUsersOptionsError() throws Throwable {
    new UpdateCatalogUsersOptions.Builder().build();
  }
