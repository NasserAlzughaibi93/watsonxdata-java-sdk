...
/**
 * Unit test class for the GetQueriesOptions model.
 */
public class GetQueriesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetQueriesOptions() throws Throwable {
    GetQueriesOptions getQueriesOptionsModel = new GetQueriesOptions.Builder()
      .authInstanceId("testString")
      .build();
    assertEquals(getQueriesOptionsModel.authInstanceId(), "testString");
  }
}