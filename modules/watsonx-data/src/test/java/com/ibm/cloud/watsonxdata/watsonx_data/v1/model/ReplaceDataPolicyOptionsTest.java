...
/**
 * Unit test class for the ReplaceDataPolicyOptions model.
 */
public class ReplaceDataPolicyOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceDataPolicyOptions() throws Throwable {
    ...
    ReplaceDataPolicyOptions replaceDataPolicyOptionsModel = new ReplaceDataPolicyOptions.Builder()
      ...
      .build();
    assertEquals(replaceDataPolicyOptionsModel.policyName(), "testString");
    assertEquals(replaceDataPolicyOptionsModel.catalogName(), "testString");
    assertEquals(replaceDataPolicyOptionsModel.dataArtifact(), "schema1/table1/(column1|column2)");
    assertEquals(replaceDataPolicyOptionsModel.rules(), java.util.Arrays.asList(ruleModel));
    assertEquals(replaceDataPolicyOptionsModel.description(), "testString");
    assertEquals(replaceDataPolicyOptionsModel.status(), "active");
    assertEquals(replaceDataPolicyOptionsModel.lhInstanceId(), "testString");
    assertEquals(replaceDataPolicyOptionsModel.authInstanceId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testReplaceDataPolicyOptionsError() throws Throwable {
    new ReplaceDataPolicyOptions.Builder().build();
  }
