...
/**
 * Unit test class for the ReplaceDataPolicyCreatedBody model.
 */
public class ReplaceDataPolicyCreatedBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReplaceDataPolicyCreatedBody() throws Throwable {
    ReplaceDataPolicyCreatedBody replaceDataPolicyCreatedBodyModel = new ReplaceDataPolicyCreatedBody();
    assertNull(replaceDataPolicyCreatedBodyModel.getDataPolicy());
    assertNull(replaceDataPolicyCreatedBodyModel.getMetadata());
    assertNull(replaceDataPolicyCreatedBodyModel.getResponse());
  }
}