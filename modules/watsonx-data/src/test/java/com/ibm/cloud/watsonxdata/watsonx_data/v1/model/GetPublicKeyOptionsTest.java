...
import com.ibm.cloud.watsonxdata.watsonx_data.v1.model.GetPublicKeyOptions;
...
public class GetPublicKeyOptionsTest {
  ...
  public void testGetPublicKeyOptions() throws Throwable {
    GetPublicKeyOptions getPublicKeyOptionsModel = new GetPublicKeyOptions();
    assertNotNull(getPublicKeyOptionsModel);
  }
}