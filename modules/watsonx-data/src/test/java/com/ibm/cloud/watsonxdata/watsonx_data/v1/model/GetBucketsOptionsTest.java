...
/**
 * Unit test class for the GetBucketsOptions model.
 */
public class GetBucketsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetBucketsOptions() throws Throwable {
    GetBucketsOptions getBucketsOptionsModel = new GetBucketsOptions.Builder()
      .authInstanceId("testString")
      .build();
    assertEquals(getBucketsOptionsModel.authInstanceId(), "testString");
  }
}