...
/**
 * Unit test class for the PolicySchemaList model.
 */
public class PolicySchemaListTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPolicySchemaList() throws Throwable {
    PolicySchemaList policySchemaListModel = new PolicySchemaList();
    assertNull(policySchemaListModel.getCatalogPolicies());
    assertNull(policySchemaListModel.getDataPolicies());
    assertNull(policySchemaListModel.getEnginePolicies());
  }
}