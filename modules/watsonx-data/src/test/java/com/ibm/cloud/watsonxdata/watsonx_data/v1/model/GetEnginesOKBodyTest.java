...
/**
 * Unit test class for the GetEnginesOKBody model.
 */
public class GetEnginesOKBodyTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetEnginesOKBody() throws Throwable {
    GetEnginesOKBody getEnginesOkBodyModel = new GetEnginesOKBody();
    assertNull(getEnginesOkBodyModel.getEngines());
    assertNull(getEnginesOkBodyModel.getResponse());
  }
}