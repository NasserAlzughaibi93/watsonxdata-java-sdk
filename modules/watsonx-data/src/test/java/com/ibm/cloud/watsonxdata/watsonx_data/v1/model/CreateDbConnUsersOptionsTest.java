...
/**
 * Unit test class for the CreateDbConnUsersOptions model.
 */
public class CreateDbConnUsersOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateDbConnUsersOptions() throws Throwable {
    ...
    CreateDbConnUsersOptions createDbConnUsersOptionsModel = new CreateDbConnUsersOptions.Builder()
      ...
      .build();
    assertEquals(createDbConnUsersOptionsModel.databaseId(), "testString");
    assertEquals(createDbConnUsersOptionsModel.groups(), java.util.Arrays.asList(bucketDbConnGroupsMetadataModel));
    assertEquals(createDbConnUsersOptionsModel.users(), java.util.Arrays.asList(bucketDbConnUsersMetadataModel));
    assertEquals(createDbConnUsersOptionsModel.lhInstanceId(), "testString");
    assertEquals(createDbConnUsersOptionsModel.authInstanceId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateDbConnUsersOptionsError() throws Throwable {
    new CreateDbConnUsersOptions.Builder().build();
  }
