...
/**
 * Unit test class for the EvaluateOptions model.
 */
public class EvaluateOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testEvaluateOptions() throws Throwable {
    ...
    EvaluateOptions evaluateOptionsModel = new EvaluateOptions.Builder()
      ...
      .build();
    assertEquals(evaluateOptionsModel.resources(), java.util.Arrays.asList(resourcesMetadataModel));
    assertEquals(evaluateOptionsModel.lhInstanceId(), "testString");
    assertEquals(evaluateOptionsModel.authInstanceId(), "testString");
  }
}