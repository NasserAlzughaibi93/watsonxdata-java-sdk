...
public class CreateSchemaOptionsTest {
  ...
  public void testCreateSchemaOptions() throws Throwable {
    CreateSchemaOptions createSchemaOptionsModel = new CreateSchemaOptions.Builder()
      ...
      .build();
    assertEquals(createSchemaOptionsModel.catalogName(), "sampleCatalog");
    assertEquals(createSchemaOptionsModel.engineId(), "sampleEngine123");
    assertEquals(createSchemaOptionsModel.schemaName(), "new_schema");
