...
/**
 * Unit test class for the CreateEngineUsersOptions model.
 */
public class CreateEngineUsersOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateEngineUsersOptions() throws Throwable {
    ...
    CreateEngineUsersOptions createEngineUsersOptionsModel = new CreateEngineUsersOptions.Builder()
      ...
      .build();
    assertEquals(createEngineUsersOptionsModel.engineId(), "testString");
    assertEquals(createEngineUsersOptionsModel.groups(), java.util.Arrays.asList(engineGroupsMetadataModel));
    assertEquals(createEngineUsersOptionsModel.users(), java.util.Arrays.asList(engineUsersMetadataModel));
    assertEquals(createEngineUsersOptionsModel.lhInstanceId(), "testString");
    assertEquals(createEngineUsersOptionsModel.authInstanceId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateEngineUsersOptionsError() throws Throwable {
    new CreateEngineUsersOptions.Builder().build();
  }
