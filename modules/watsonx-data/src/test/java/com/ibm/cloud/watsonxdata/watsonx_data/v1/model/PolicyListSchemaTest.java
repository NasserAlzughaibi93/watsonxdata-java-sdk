...
/**
 * Unit test class for the PolicyListSchema model.
 */
public class PolicyListSchemaTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testPolicyListSchema() throws Throwable {
    PolicyListSchema policyListSchemaModel = new PolicyListSchema();
    assertNull(policyListSchemaModel.getPolicies());
    assertNull(policyListSchemaModel.getTotalCount());
  }
}