...
/**
 * Unit test class for the GetMetastoresOptions model.
 */
public class GetMetastoresOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetMetastoresOptions() throws Throwable {
    GetMetastoresOptions getMetastoresOptionsModel = new GetMetastoresOptions.Builder()
      .authInstanceId("testString")
      .build();
    assertEquals(getMetastoresOptionsModel.authInstanceId(), "testString");
  }
}