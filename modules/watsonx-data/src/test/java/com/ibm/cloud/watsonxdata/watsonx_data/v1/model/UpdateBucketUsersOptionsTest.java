...
/**
 * Unit test class for the UpdateBucketUsersOptions model.
 */
public class UpdateBucketUsersOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateBucketUsersOptions() throws Throwable {
    ...
    UpdateBucketUsersOptions updateBucketUsersOptionsModel = new UpdateBucketUsersOptions.Builder()
      ...
      .build();
    assertEquals(updateBucketUsersOptionsModel.bucketId(), "testString");
    assertEquals(updateBucketUsersOptionsModel.groups(), java.util.Arrays.asList(bucketDbConnGroupsMetadataModel));
    assertEquals(updateBucketUsersOptionsModel.users(), java.util.Arrays.asList(bucketDbConnUsersMetadataModel));
    assertEquals(updateBucketUsersOptionsModel.lhInstanceId(), "testString");
    assertEquals(updateBucketUsersOptionsModel.authInstanceId(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateBucketUsersOptionsError() throws Throwable {
    new UpdateBucketUsersOptions.Builder().build();
  }
