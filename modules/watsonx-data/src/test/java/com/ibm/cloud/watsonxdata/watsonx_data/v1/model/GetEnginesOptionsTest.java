...
/**
 * Unit test class for the GetEnginesOptions model.
 */
public class GetEnginesOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetEnginesOptions() throws Throwable {
    GetEnginesOptions getEnginesOptionsModel = new GetEnginesOptions.Builder()
      .authInstanceId("testString")
      .build();
    assertEquals(getEnginesOptionsModel.authInstanceId(), "testString");
  }
}