 ...
 */
public class UpdateMetastoreUsersOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing UpdateMetastoreUsersOptions instance.
     *
     * @param updateMetastoreUsersOptions the instance to initialize the Builder with
     */
    private Builder(UpdateMetastoreUsersOptions updateMetastoreUsersOptions) {
      this.metastoreName = updateMetastoreUsersOptions.metastoreName;
      this.groups = updateMetastoreUsersOptions.groups;
      this.users = updateMetastoreUsersOptions.users;
      this.lhInstanceId = updateMetastoreUsersOptions.lhInstanceId;
      this.authInstanceId = updateMetastoreUsersOptions.authInstanceId;
    }
    ...
    /**
     * Builds a UpdateMetastoreUsersOptions.
     *
     * @return the new UpdateMetastoreUsersOptions instance
     */
    public UpdateMetastoreUsersOptions build() {
      return new UpdateMetastoreUsersOptions(this);
    }
     ...
     * @return the UpdateMetastoreUsersOptions builder
     */
  ...
  protected UpdateMetastoreUsersOptions() { }

  protected UpdateMetastoreUsersOptions(Builder builder) {
   ...
   * New builder.
   *
   * @return a UpdateMetastoreUsersOptions builder
   */
