 ...
 */
public class GetMetastoreUsersSchema extends GenericModel {

  protected List<GroupsMetadata> groups;
  @SerializedName("metastore_name")
  protected String metastoreName;
  @SerializedName("total_count")
  protected Long totalCount;
  protected List<UsersMetadata> users;

  protected GetMetastoreUsersSchema() { }
   ...
   * @return the groups
   */
  public List<GroupsMetadata> getGroups() {
    return groups;
  }
   ...
   * @return the users
   */
  public List<UsersMetadata> getUsers() {
    return users;
  }
}
