...
public class PreauthOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing PreauthOptions instance.
     *
     * @param preauthOptions the instance to initialize the Builder with
     */
     ...
     *
     * @return the new PreauthOptions instance
     */
     ...
     * @return the PreauthOptions builder
     */
   ...
   * New builder.
   *
   * @return a PreauthOptions builder
   */
