...
public class EngineUsersMetadata extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing EngineUsersMetadata instance.
     *
     * @param engineUsersMetadata the instance to initialize the Builder with
     */
    ...
    /**
     * Builds a EngineUsersMetadata.
     *
     * @return the new EngineUsersMetadata instance
     */
     ...
     *
     * @param permission the permission
     * @return the EngineUsersMetadata builder
     */
   ...
   * New builder.
   *
   * @return a EngineUsersMetadata builder
   */
