 ...
 * DataPolicies.
 */
public class DataPolicies extends GenericModel {

  @SerializedName("associate_catalog")
  protected String associateCatalog;
  @SerializedName("policy_name")
  protected String policyName;
  @SerializedName("policy_version")
  protected String policyVersion;

  protected DataPolicies() { }
   ...
   * Associate catalog.
   *
   * @return the associateCatalog
   */
  public String getAssociateCatalog() {
    return associateCatalog;
  }
