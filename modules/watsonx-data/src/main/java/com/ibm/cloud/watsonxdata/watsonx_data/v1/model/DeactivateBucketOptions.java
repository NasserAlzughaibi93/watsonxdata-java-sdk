...
public class DeactivateBucketOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeactivateBucketOptions instance.
     *
     * @param deactivateBucketOptions the instance to initialize the Builder with
     */
    ...
    /**
     * Builds a DeactivateBucketOptions.
     *
     * @return the new DeactivateBucketOptions instance
     */
     ...
     *
     * @param bucketId the bucketId
     * @return the DeactivateBucketOptions builder
     */
   ...
   * New builder.
   *
   * @return a DeactivateBucketOptions builder
   */
