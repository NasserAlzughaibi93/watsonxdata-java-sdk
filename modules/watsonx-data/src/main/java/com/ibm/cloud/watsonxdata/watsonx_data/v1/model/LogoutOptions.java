...
public class LogoutOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing LogoutOptions instance.
     *
     * @param logoutOptions the instance to initialize the Builder with
     */
    ...
    /**
     * Builds a LogoutOptions.
     *
     * @return the new LogoutOptions instance
     */
     ...
     * @return the LogoutOptions builder
     */
   ...
   * New builder.
   *
   * @return a LogoutOptions builder
   */
