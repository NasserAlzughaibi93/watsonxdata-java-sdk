...
// >>> Replace "watsonx_data" with the correct value for your project
package com.ibm.cloud.watsonx_data.common;
...
public class SdkCommon {
    ...
    // >>> Replace "watsonx-data" with the parent project's artifactId (e.g. platform-services)
    private static String parentArtifactId = "watsonx-data";
